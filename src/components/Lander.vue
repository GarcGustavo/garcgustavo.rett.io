    ...
    <div>
        ...
        <section class="section">
            <div class="container-fliud">
                <img alt="Vue logo" class="rounded-circle" src="../assets/images (1).jpeg">
                <h1>Gustavo A. Reyes Carrion</h1>
                <h2>Software Engineer</h2>
                <p>Hi, my name is Gustavo and this is my devlog. I'm a software engineer and this website is dedicated to cataloguing and sharing my latest projects.</p>
                <h3>Devlog</h3>
                <h3>Resume</h3>
                <h3>Contact</h3>
